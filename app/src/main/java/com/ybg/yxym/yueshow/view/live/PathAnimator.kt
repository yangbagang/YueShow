...
class PathAnimator(config: AbstractPathAnimator.Config) : AbstractPathAnimator(config) {
    ...
    internal class FloatAnimation(path: Path, private val mRotation: Float, parent: View, private val mView: View) : Animation() {
