...
class HotShowAdapter(protected var mContext: Activity) : BaseAdapter() {
    private var width = 0
    /**
     * 屏幕的宽度
     */
     ...
     * 转发点击事件
     */
    private inner class BtnTransOnClickListener(internal var mPosition:

                                                Int) : View.OnClickListener {
     ...
     * 头像点击事件
     */
    private inner class BtnPhotoOnClickListener(internal var mPosition:
