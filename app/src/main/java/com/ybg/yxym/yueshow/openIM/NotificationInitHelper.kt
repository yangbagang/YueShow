 ...
 * @author zhaoxu
 */
class NotificationInitHelper(pointcut: Pointcut) : IMNotification(pointcut) {

    fun setNeedQuiet(needQuiet: Boolean) {
        mNeedQuiet = needQuiet
    }

    fun setNeedVibrator(needVibrator: Boolean) {
        mNeedVibrator = needVibrator
    }

    fun setNeedSound(needSound: Boolean) {
     ...
     */
    override fun needQuiet(conversation: YWConversation?, message: YWMessage?): Boolean {
     ...
     */
    override fun needVibrator(conversation: YWConversation?, message: YWMessage?): Boolean {
        //        if (conversation.getConversationType() == YWConversationType.Tribe){
        //            return false;
        //        }
     ...
     */
    override fun needSound(conversation: YWConversation?, message: YWMessage?): Boolean {
        //        if (conversation.getConversationType() == YWConversationType.Tribe){
        //            return false;
        //        }
        return mNeedSound
     ...
     */
    override fun getNotificationTips(conversation: YWConversation?, message: YWMessage?, totalUnReadCount: Int, smilyCache: IMSmilyCache?): CharSequence? {
     ...
     */
    override fun getCustomNotificationIntent(conversation: YWConversation?, message: YWMessage?, totalUnReadCount: Int): Intent? {
     ...
     */
    override fun getNotificationSoundResId(): Int {
        return 0
    }
     ...
     */
    override fun getTicker(conversation: YWConversation?, message: YWMessage?, totalUnReadCount: Int): String? {
        //        return "123456";
        return null
    }
    ...
    companion object {
        ...
        private var mNeedQuiet: Boolean = false
        private var mNeedVibrator = true
        private var mNeedSound = true

        fun init() {
            val imKit = LoginHelper.instance.imKit
            if (imKit != null) {
