...
//                    notifyDataSetChanged();
    ...
    public void handleVoiceMsg(final Message msg, final MsgListAdapter.ViewHolder holder, final int position) {
    ...
    public void handleLocationMsg(final Message msg, final MsgListAdapter.ViewHolder holder, int position) {
    ...
    public void handleFileMsg(final Message msg, final MsgListAdapter.ViewHolder holder, int position) {
    ...
    public void handleGroupChangeMsg(Message msg, MsgListAdapter.ViewHolder holder) {
    ...
    public void handleCustomMsg(Message msg, MsgListAdapter.ViewHolder holder) {
...
//        }
    ...
    public class BtnOrTxtListener implements View.OnClickListener {
        ...
        public BtnOrTxtListener(int index, MsgListAdapter.ViewHolder viewHolder) {
            this.position = index;
    ...
    public void playVoice(final int position, final MsgListAdapter.ViewHolder holder, final boolean isSender) {
        // 记录播放录音的位置
        mPosition = position;
        Message msg = mMsgList.get(position);
        if (autoPlay) {
