...
import com.ybg.yxym.im.activity.AudioFragment;
import com.ybg.yxym.im.activity.DocumentFragment;
import com.ybg.yxym.im.activity.ImageFragment;
import com.ybg.yxym.im.activity.OtherFragment;
import com.ybg.yxym.im.activity.SendFileActivity;
import com.ybg.yxym.im.activity.VideoFragment;
import com.ybg.yxym.im.adapter.ViewPagerAdapter;
...
import com.ybg.yxym.im.listener.UpdateSelectedStateListener;
...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public SendFileController(SendFileActivity context, SendFileView view) {
        ...
        String targetId = mContext.getIntent().getStringExtra(IMConstants.TARGET_ID);
        String targetAppKey = mContext.getIntent().getStringExtra(IMConstants.TARGET_APP_KEY);
        long groupId = mContext.getIntent().getLongExtra(IMConstants.GROUP_ID, 0);
        if (groupId != 0) {
            ...
            if (controller != null) {
                switch (msg.what) {
                    case SEND_FILE:
                        ...
                        intent.putExtra(IMConstants.MsgIDs, controller.mMsgIds);
                        controller.mContext.setResult(IMConstants.RESULT_CODE_SEND_FILE, intent);
