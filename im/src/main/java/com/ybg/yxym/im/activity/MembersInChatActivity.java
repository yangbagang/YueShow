...
import com.ybg.yxym.im.adapter.AllMembersAdapter;
...
public class MembersInChatActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGroupId = getIntent().getLongExtra(IMConstants.GROUP_ID, 0);
        mIsDeleteMode = getIntent().getBooleanExtra(IMConstants.DELETE_MODE, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_btn:
                    ...
                    setResult(IMConstants.RESULT_CODE_ALL_MEMBER, intent);
                    finish();
                    break;
                case R.id.right_btn:
                    if (mIsDeleteMode) {
