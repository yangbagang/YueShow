...
public class ConversationListView {
	...
	public void initModule() {
		mConvListView = (ListView) mConvListFragment.findViewById(R.id.conversation_list_view);
        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mHeader = (LinearLayout) inflater.inflate(R.layout.conversation_list_head_view, mConvListView, false);
