...
import com.ybg.yxym.im.adapter.AlbumListAdapter;
import com.ybg.yxym.im.constants.IMConstants;
import com.ybg.yxym.im.entity.ImageBean;
import com.ybg.yxym.im.tools.SortPictureList;
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
        ...
        setCustomTitle(this.getString(R.string.choose_album_title));
        getImages();
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivityForResult(mIntent, IMConstants.REQUEST_CODE_SELECT_ALBUM);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == IMConstants.RESULT_CODE_SELECT_ALBUM) {
            setResult(IMConstants.RESULT_CODE_SELECT_PICTURE, data);
            finish();
        }
    }
