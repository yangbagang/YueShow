package com.ybg.yxym.im.receiver;
    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            if (type == ConversationType.single) {
                ...
                notificationIntent.putExtra(IMConstants.TARGET_ID, targetId);
                notificationIntent.putExtra(IMConstants.TARGET_APP_KEY, appKey);
                Log.d("Notification", "msg.fromAppKey() " + appKey);
            } else {
                conv = JMessageClient.getGroupConversation(Long.parseLong(targetId));
                notificationIntent.putExtra(IMConstants.GROUP_ID, Long.parseLong(targetId));
            }
